...
var dataArr = JSON.parse(localStorage.getItem('obj'));

//console.log(_.map(dataArr, 'skills'));
//console.log(_.flatten(_.map(dataArr, 'skills')));
console.log('Skills = ', _.sortBy(_.uniq(_.flatten(_.map(dataArr, 'skills')))));

console.log('-----------------------------');
//console.log( _.sortBy(dataArr, 'friends'));
console.log('Names = ', _.map( _.sortBy(dataArr, 'friends'), 'name'));

console.log('-----------------------------');
//console.log(_.map(dataArr, 'friends'));
//console.log(_.flatten(_.map(dataArr, 'friends')));
console.log('Names friends = ', _.sortBy(_.uniq(_.map(_.flatten(_.map(dataArr, 'friends')), 'name'))));
